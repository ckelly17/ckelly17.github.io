...
ggplotly(sa_ratio_plot) %>%
  layout(
    title = paste(
      '<b>Week-Over-Week Case Growth Multiplier</b>',
      '<br><span style="font-size: 12px;">',
      'Change in 7-day average cases compared to prior week. Y-axis scale is logarithmic.'
    ),
    margin = list(t = 100)
  )
```
...
ggplotly(icu_pct_plot) %>%
  ...
  layout(
    title = paste(
      '<b>Severity of Hospitaliations</b>',
      '<br><span style="font-size: 12px;">',
      'Percentage of COVID-19 patients in ICU and ventilated in South Africa and Gauteng Province over time'
    ),
    margin = list(t = 100))
```
